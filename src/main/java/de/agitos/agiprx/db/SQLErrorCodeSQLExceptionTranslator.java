...
import de.agitos.agiprx.db.exception.CannotAcquireLockException;
import de.agitos.agiprx.db.exception.CannotSerializeTransactionException;
...
import de.agitos.agiprx.db.exception.DeadlockLoserDataAccessException;
...
import de.agitos.agiprx.db.util.SingletonSupplier;
import de.agitos.agiprx.db.util.SupplierUtils;
...
public class SQLErrorCodeSQLExceptionTranslator extends AbstractFallbackSQLExceptionTranslator {
	...
	private static final Logger LOG = Logger.getLogger(SQLErrorCodeSQLExceptionTranslator.class.getName());
	...
	protected DataAccessException doTranslate(String task,  String sql, SQLException ex) {
		...
		if (LOG.isLoggable(Level.FINE)) {
			...
			LOG.log(Level.FINE, "Unable to translate SQLException with " + codes + ", will now try the fallback translator");
		}
	...
	protected DataAccessException createCustomException(
		...
		try {
			...
			switch (constructorType) {
				...
				default:
					if (LOG.isLoggable(Level.WARNING)) {
						LOG.log(Level.WARNING, "Unable to find appropriate constructor of custom exception class [" +
			...
			if (LOG.isLoggable(Level.WARNING)) {
				LOG.log(Level.WARNING, "Unable to instantiate custom exception class [" + exceptionClass.getName() + "]", ex);
			}
			return null;
		}
	}
	...
	private void logTranslation(String task,  String sql, SQLException sqlEx, boolean custom) {
		if (LOG.isLoggable(Level.FINE)) {
			...
			LOG.log(Level.FINE, intro + " SQLException with SQL state '" + sqlEx.getSQLState() +
