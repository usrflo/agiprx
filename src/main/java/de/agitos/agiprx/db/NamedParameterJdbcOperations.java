 ...
 * {@link org.springframework.jdbc.core.JdbcOperations} interface, implemented
 * by {@link NamedParameterJdbcTemplate}. This interface is not often used
...
public interface NamedParameterJdbcOperations {
	...
	/**
	 * Query given SQL to create a prepared statement from SQL, reading the
	 * ResultSet with a ResultSetExtractor.
	 * <p>
	 * Note: In contrast to the JdbcOperations method with the same signature, this
	 * query variant always uses a PreparedStatement. It is effectively equivalent
	 * to a query call with an empty parameter Map.
	 * 
	 * @param sql the SQL query to execute
	 * @param rse object that will extract results
	 * @return an arbitrary result object, as returned by the ResultSetExtractor
	...
	/**
	 * Query given SQL to create a prepared statement from SQL, mapping each row to
	 * a Java object via a RowMapper.
	 * <p>
	 * Note: In contrast to the JdbcOperations method with the same signature, this
	 * query variant always uses a PreparedStatement. It is effectively equivalent
	 * to a query call with an empty parameter Map.
	 ...
	 *                                                                        that
	 *                                                                        row
	 * @throws DataAccessException                                            if the
	 *                                                                        query
	 *                                                                        fails
	 */
	...
	// <T> T queryForObject(String sql, SqlParameterSource paramSource, Class<T>
	// requiredType) throws DataAccessException;
	...
	// <T> T queryForObject(String sql, Map<String, ?> paramMap, Class<T>
	// requiredType) throws DataAccessException;
	 ...
	 * domain model. Otherwise, consider using one of the queryForObject() methods.
	 * <p>
	 * The query is expected to be a single row query; the result row will be mapped
	 * to a Map (one entry for each column, using the column name as the key).
	 * 
	 ...
	 */
	// <T> List<T> queryForList(String sql, SqlParameterSource paramSource, Class<T>
	// elementType) throws DataAccessException;
	 ...
	 * @see org.springframework.jdbc.core.SingleColumnRowMapper
	 */
	// <T> List<T> queryForList(String sql, Map<String, ?> paramMap, Class<T>
	// elementType) throws DataAccessException;
	 ...
	 * 
	 * @param sql                the SQL containing named parameters
	 * @param paramSource        container of arguments and SQL types to bind to the
	 *                           query
	 * @param generatedKeyHolder a {@link KeyHolder} that will hold the generated
	 *                           keys
	 * @return the number of rows affected
	 * @throws DataAccessException if there is any problem issuing the update
	 ...
	 * @param generatedKeyHolder a {@link KeyHolder} that will hold the generated
	 *                           keys
	 * @param keyColumnNames     names of the columns that will have keys generated
	 *                           for them
	 * @return the number of rows affected
	 * @throws DataAccessException if there is any problem issuing the update
	 * @see MapSqlParameterSource
