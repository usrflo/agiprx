...
public class Assert {
	...
	public static void singleton(Object bean, Object instanceVar) {
		if (instanceVar != null && bean != instanceVar) {
			throw new RuntimeException("Singleton is already instantiated");
		}
	}
