...
class ResourceRecords {
	...
	/*
	 * True if these resource records are from a zone transfer. In that case only
	 * answer records are read (as per draft-ietf-dnsext-axfr-clarify-02.txt). Also,
	 * the rdata of those answer records is not decoded (for efficiency) except for
	 * SOA records.
	 */
	boolean zoneXfer;

	/*
	 * Returns a representation of the resource records in a DNS message. Does not
	 * modify or store a reference to the msg array.
	 */
	...
	/*
	 * Decodes the resource records in a DNS message and adds them to this object.
